...
import 'package:team_app/alif/checkPage2.dart';
...
import 'package:team_app/alif/testNews_page.dart';
...
void main() async {
  ...
  var controller = NewsController(services);
...
class TodoApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Newspage(controller: controller),
    );
  }
}
